...
async def test_docker_switch_follows_the_engine_proxy_but_its_sensors_do_not(
    ...
    # state and health sensors read the proxy just like the switch does, while
    # the usage sensors read whatever the container list reported and blank
    # themselves when there is nothing to report.
    engine_backed = {
