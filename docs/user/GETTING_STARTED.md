...
This guide will help you install and set up the MOS custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/anym001/ha-mos`
6. Set category to "Integration"
7. Click "Add"
8. Find "MOS" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/anym001/ha-mos/releases)
2. Extract the `mos` folder from the archive
3. Copy it to `custom_components/mos/` in your Home Assistant configuration directory
...
- Report issues at [GitHub Issues](https://github.com/anym001/ha-mos/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/anym001/ha-mos/discussions)
