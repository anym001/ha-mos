...
- `entity/` — Base entity class (`MOSEntity`)
...
- Entity MRO: `(PlatformEntity, MOSEntity)` — order matters
...
- Debug level: `custom_components.mos: debug` in `config/configuration.yaml`
