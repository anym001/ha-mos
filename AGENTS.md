...
- `custom_components/mos/` - Main integration code
...
- Integration logs: `custom_components.mos: debug` in `config/configuration.yaml`
...
- Inherit from platform base + `MOSEntity`
...
- `tests/` mirrors `custom_components/mos/` structure
